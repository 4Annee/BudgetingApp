...
<body class="font-roboto mh-100">
    ...
    <main class="mt-1 mx-auto mb-4">
        <aside class="pt-1">
            ...
            <div class="sidebar">
                <a href="dashboard.blade.php" class="flexrow text-gray">
                ...
                <a href="settings.blade.php" class="flexrow text-gray">
        ...
        <section class="middle">
            <button id="add"><a href="#">Add</a></button>
            <table>
                <thead>
                  <tr>
                    <th>Destination</th>
